    ...
    <div className="card-body">
      ...
      <div className="mb-4">
        ...
        {workExperience.map((exp, index) => (
          <div key={index} className="mb-3">
            ...
            <div className="text-center"> {/* Aligning the delete button */}
              <button
        ...
        <div className="text-center"> {/* Aligning the add button */}
          <button
      ...
      <div className="mb-4">
        ...
        <div className="text-center">
          <button className="btn btn-primary mr-2" onClick={handleSaveInfo}>
            Save Info
          </button>
        </div>
      </div>
